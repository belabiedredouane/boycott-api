...
- Check existing [issues](https://github.com/yaqiin/boycott-api/issues) first
- Open a new issue if it's not reported yet
- Include steps to reproduce the bug

## 💡 Suggest Improvements

- Open an [issue](https://github.com/yaqiin/boycott-api/issues) to discuss your idea
...
- Open a [pull request](https://github.com/yaqiin/boycott-api/pulls) with:
